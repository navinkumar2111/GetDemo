...
public class Filter {
	...
	public static void main(String[] args) {
		...
		List<WebElement>  VeggieSorted=veggie.stream().filter(Veggie->Veggie.getText().contains("Rice")).collect(Collectors.toList());
        Assert.assertEquals(veggie.size(), VeggieSorted.size());
	}
}
